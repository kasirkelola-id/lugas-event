      ...
      if (result['success']) {
        ...
        try {
          ...
          return {
            'success': false,
            'message':
                'Data aplikasi tidak dapat dimuat (Error Parsing Attendance)',
            'isParsingError': true,
          };
        }
      }
  ...
  static Future<Map<String, dynamic>> checkIn(
    ...
    try {
      ...
      return {
        'success': false,
        'message':
            'Server tidak dapat dihubungi. Periksa koneksi internet Anda.',
      };
    }
  }
    ...
    try {
      ...
      if (result['success']) {
        try {
          ...
          return {
            'success': false,
            'message': 'Error Parsing Attendance Status',
          };
        }
      }
      return result;
      ...
      if (result['success']) {
        ...
        try {
          ...
          return {
            'success': false,
            'message':
                'Data aplikasi tidak dapat dimuat (Error Parsing Event Attendance)',
            'isParsingError': true,
          };
        }
      }
