...
class PengelolaProfilScreen extends StatefulWidget {
  ...
  @override
  State<PengelolaProfilScreen> createState() => _PengelolaProfilScreenState();
}

class _PengelolaProfilScreenState extends State<PengelolaProfilScreen> {
  UserModel? _user;
                  ...
                  child: Column(
                    children: [
                      ...
                      _buildInfoTile(
                        ...
                        'WhatsApp',
                        _user!.noWhatsapp.isEmpty ? '-' : _user!.noWhatsapp,
                      ),
                      const Padding(
                        padding: EdgeInsets.symmetric(vertical: 12),
                        child: Divider(height: 1, color: Colors.black12),
                      ...
                      _buildInfoTile(
                        ...
                        valueColor: _user!.statusAktif == 1
                            ? AppTheme.success
                            : AppTheme.error,
                      ),
                    ],
